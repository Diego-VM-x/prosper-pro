      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <section>
            ...
            <p>{t('terms.sections.4.text')}</p>
          </section>

          <section>
            <h2>{t('terms.sections.5.title')}</h2>
            <p>{t('terms.sections.5.text')}</p>
          </section>

          <section>
            <h2>{t('terms.sections.6.title')}</h2>
            <p>{t('terms.sections.6.text')}</p>
          </section>
          ...
          <section>
            ...
            <p>{t('terms.sections.11.text')} <a href="mailto:soporte@prosperpro.com">soporte@prosperpro.com</a></p>
          </section>
        </div>
