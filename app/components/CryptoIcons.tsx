...
export const BtcIcon: React.FC<CryptoIconProps> = ({ size = 20, className = '' }) => (
  <svg
...
export const EthIcon: React.FC<CryptoIconProps> = ({ size = 20, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    width={size}
...
export const UsdtIcon: React.FC<CryptoIconProps> = ({ size = 20, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    width={size}
...
export const SolIcon: React.FC<CryptoIconProps> = ({ size = 20, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    width={size}
...
export const UsdcIcon: React.FC<CryptoIconProps> = ({ size = 20, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 32 32"
    width={size}
...
// Map currency codes to their icon components
const CRYPTO_ICON_MAP: Record<string, React.FC<CryptoIconProps>> = {
  BTC: BtcIcon,
  ETH: EthIcon,
  USDT: UsdtIcon,
  SOL: SolIcon,
 ...
 */
export const CurrencyFlag: React.FC<{ code: string; size?: number; className?: string }> = ({
  code,
  size = 20,
  className = '',
}) => {
  const upperCode = code.toUpperCase();
  const CryptoComponent = CRYPTO_ICON_MAP[upperCode];
...
/**
 * Check if a currency code is a known crypto with an SVG icon.
 */
export function isCryptoCurrency(code: string): boolean {
  return code.toUpperCase() in CRYPTO_ICON_MAP;
}
