/**
 * @file icons.tsx
 * @description Biblioteca de iconos SVG inline para Prosper-Pro Dashboard.
 * Evita dependencias externas y mantiene el bundle ligero.
 */
...
/** Icono de tutorial / graduación */
export function IconTutorial(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** Icono de flecha diagonal / enlace externo */
...
/** Icono de escudo / hoja de Prosper */
export function IconProsperLeaf(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
/** Icono de avión / viaje */
export function IconFlight(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
